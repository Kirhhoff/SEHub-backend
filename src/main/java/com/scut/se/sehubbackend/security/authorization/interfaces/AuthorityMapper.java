...
public interface AuthorityMapper {
     ...
     * @return 构造出的权限
     */
    GrantedAuthority map(PositionEnum positionEnum, DepartmentNameEnum departmentNameEnum);
     ...
     * @return 构造出的动态权限
     */
    GrantedAuthority mapDynamic(DepartmentNameEnum departmentNameEnum, DynamicDetail detail);

    Set<GrantedAuthority> mapAllDynamic(DepartmentNameEnum departmentNameEnum);
}
