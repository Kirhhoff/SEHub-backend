...
public interface AuthorityMapper {
     ...
     * @return 构造出的权限
     */
    GrantedAuthority map(Position position, DepartmentEnum departmentEnum);
     ...
     * @return 构造出的动态权限
     */
    GrantedAuthority mapDynamic(DepartmentEnum departmentEnum, DynamicDetail detail);

    Set<GrantedAuthority> mapAllDynamic(DepartmentEnum departmentEnum);
}
